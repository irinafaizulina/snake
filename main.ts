namespace SpriteKind {
    export const kind_tail = SpriteKind.create()
    export const menu = SpriteKind.create()
    export const kind_options = SpriteKind.create()
}
function option () {
    level = 2
    easy = sprites.create(img`
        ...
        .f.....f..f..f.......ffff...........
        .f.....f..f..f........ff............
        .ffff.ffffff.fffff....ff............
        .f....f....f.....f....ff............
        .f....f....f.....f....ff............
        .ffff.f....f.fffff....ff............
        ....................................
        `, SpriteKind.kind_options)
    medium = sprites.create(img`
        ........................................
        .ff...ff.fffff.ffff...ff.f...f.f...f....
        .ff...ff.f.....f...f..ff.f...f.ff.ff....
        .fff.fff.f.....f...f.....f...f.f.f.f....
        .f.fff.f.fffff.f...f..ff.f...f.f...f....
        .f.....f.f.....f...f..ff.f...f.f...f....
        .f.....f.f.....f...f..ff.f...f.f...f....
        .f.....f.f.....f...f..ff.f...f.f...f....
        .f.....f.fffff.ffff...ff.fffff.f...f....
        ........................................
        `, SpriteKind.kind_options)
    hard = sprites.create(img`
        ...
        ....................................
        `, SpriteKind.kind_options)
    cursor_options = sprites.create(img`
        ...
        ffffffffffffffffffffffffffffffffffffffffff
        `, SpriteKind.kind_options)
    easy.setPosition(80, 45)
    medium.setPosition(80, 60)
    hard.setPosition(80, 75)
}
controller.up.onEvent(ControllerButtonEvent.Pressed, function () {
    if (level == 0) {
        cursor.y = 85
    } else if (level == 2) {
        if (cursor_options.y > 45) {
            cursor_options.y += -15
        }
    }
})
...
function Apple () {
    App = sprites.create(img`
        ...
        . 2 2 2 2 2 2 . 
        `, SpriteKind.Food)
    A = Math.round(randint(16, scene.screenWidth() - 16) / 8)
    B = Math.round(randint(24, scene.screenHeight() - 16) / 8)
    App.setPosition(A * 8 - 4, B * 8 - 4)
    music.play(music.melodyPlayable(music.pewPew), music.PlaybackMode.UntilDone)
}
function tail () {
    tail_list.push(sprites.create(img`
        f 2 f f f f f f 
        f f f f f f 2 f 
        f f 2 f 2 f f f 
        f f f f f f f f 
        ...
        f f f f f f 2 f 
        f 2 f f 2 f f f 
        `, SpriteKind.kind_tail))
    tail_list[tail_list.length - 1].setPosition(head.x, head.y)
    if (tail_list.length - 1 > info.score()) {
        sprites.destroy(tail_list.shift())
    }
}
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    if (level == 0) {
        ...
        if (cursor_options.y == 45) {
            how_hard_the_level_is = 1
        } else if (cursor_options.y == 60) {
            how_hard_the_level_is = 2
        } else if (cursor_options.y == 75) {
            how_hard_the_level_is = 3
        }
        sprites.destroyAllSpritesOfKind(SpriteKind.kind_options)
        menu2()
    }
})
function menu2 () {
    ...
    options = sprites.create(img`
        ..............................................
        .ffff.ffff.fffff..f..ffff..ff..f..fff.........
        .f..f.f..f...f....f..f..f..ff..f..f...........
        .f..f.f..f...f....f..f..f..f.f.f..f...........
        .f..f.ffff...f....f..f..f..f.f.f..fff.........
        .f..f.f......f....f..f..f..f..ff....f.........
        .f..f.f......f....f..f..f..f...f....f.........
        .ffff.f......f....f..ffff..f...f.ffff.........
        ..............................................
        ..............................................
        `, SpriteKind.menu)
    cursor = sprites.create(img`
        ...
        . f f f f f f f . . 
        `, SpriteKind.menu)
    go.setPosition(102, 85)
    options.setPosition(108, 98)
    cursor.setPosition(76, 85)
    level = 0
}
sprites.onOverlap(SpriteKind.Player, SpriteKind.kind_tail, function (sprite, otherSprite) {
...
function wall () {
    if (how_hard_the_level_is != 3) {
        if (der == 1 && head.top == 8) {
            head.y = scene.screenHeight() - 12
        } else if (der == 2 && head.right == scene.screenWidth()) {
            head.x = 12
        } else if (der == 3 && head.bottom == scene.screenHeight()) {
            head.y = 20
        } else if (der == 4 && head.left == 0) {
            head.x = scene.screenWidth() - 12
        }
    } else {
        if (der == 1 && head.top == 8) {
            game.gameOver(false)
...
function start () {
    scene.setBackgroundImage(img`
        
        ...
        
...
let go: Sprite = null
let how_hard_the_level_is = 0
let tail_list: Sprite[] = []
let B = 0
let A = 0
let App: Sprite = null
...
let cursor_options: Sprite = null
